...
> Status: gap as of v0.2 (2026-04-29). MVP: 5月W2. Full rollout: 5月W3.
>
...
APM/uptime は別レイヤー（5月後半に Better Uptime 等を検討）。
...
- [ ] Snapshot diff (ScaNavi のみ)
- [ ] STATE.md updater

### W3 (5月)
- [ ] AgentStars + CardWize 拡大
- [ ] Spec-aware probe
- [ ] Linksee Memory bridge
- [ ] 1週間 dry-run

### W4 (5月)
- [ ] KanseiLink + Linksee Memory 拡大（5/5プロダクト）
- [ ] Slack alerter
- [ ] 公開記事第一弾
